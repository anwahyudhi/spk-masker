    ...
    <body>
     ...
     <div class="panel">
        <center>
            ...
            <h5>Ubah Data Subkriteria <?php echo $data['nama_subkriteria'] ?></h5>
        </div>  
        <div class="panel-body">
            <br>
            <form  class="form" action="proses_edit_subkriteria.php?subkriteria=<?php echo $data['id_subkriteria'] ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input type="number" name="bobot" class="form-control" value="<?php echo $data['bobot_subkriteria'] ?>" step="0.01">
                </div>
                <br>
                <div class="form-group">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title">Konfirmasi Perubahan Data Subkriteria <?php echo $data['nama_subkriteria'] ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <div class="modal-body">
                                apakah anda yakin dengan Data Subkkriteria <?php echo $data['nama_subkriteria'] ?> yang telah inputkan?
                            </div>
