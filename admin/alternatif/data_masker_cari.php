        ...
        <center>
            ...
            <div class="panel-body">
                <table class="table table-responsive table-hover table-bordered"  style="text-align:justify">
                    ...
                    <tbody>
                        <?php
                            $sql = "SELECT * FROM masker where nama_masker like '%$cari%'";
                            $no  = 1;
                         ...
                         <td>
                            <a href="edit_masker.php?masker=<?php echo $data['id_masker'] ?>" class="btn btn-warning btn-sm btn-fill btn-block">
                        ...
                        <!-- Modal -->
                         <div class="modal" id="confirm-submit" style="color: black;">
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <input type="submit" required name="nanam" value = "Yakin" class="btn btn-primary btn-fill" data-bs-dismiss="modal"></form>
