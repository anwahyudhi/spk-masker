    ...
    <body>
     ...
     <div class="panel">
        <center>
            ...
            <h5>Ubah Data Masker <?php echo $data['nama_masker'] ?></h5>
        </div>  
        <div class="panel-body">
            <br>
            <form  class="form" action="proses_edit_masker.php?masker=<?php echo $data['id_masker'] ?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label>Jenis Masker</label>
                    <input type="text" name="nama" class="form-control" value="<?php echo $data['nama_masker'] ?>" required>
                </div>
                <br>
                <div class="form-group">
                    ...
                    <?php
                        ...
                        foreach ($dbh->query($sql) as $data1) :
                         ?>
                          <option value="<?php echo $data1['id_subkriteria'] ?>"<?php if($data['lapisan_masker'] == $data1['id_subkriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_subkriteria']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        foreach ($dbh->query($sql) as $data1) :
                         ?>
                         <option value="<?php echo $data1['id_subkriteria'] ?>"<?php if($data['kualitas_masker'] == $data1['id_subkriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_subkriteria']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        foreach ($dbh->query($sql) as $data1) :
                         ?>
                        <option value="<?php echo $data1['id_subkriteria'] ?>"<?php if($data['efektifitas_masker'] == $data1['id_subkriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_subkriteria']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        foreach ($dbh->query($sql) as $data1) :
                         ?>
                        <option value="<?php echo $data1['id_subkriteria'] ?>"<?php if($data['kenyamanan_masker'] == $data1['id_subkriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_subkriteria']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <?php
                       ...
                       foreach ($dbh->query($sql) as $data1) :
                         ?>
                        <option value="<?php echo $data1['id_subkriteria'] ?>"<?php if($data['reuse'] == $data1['id_subkriteria']) { ?> selected="selected"<?php } ?>><?php echo $data1['nama_subkriteria']; ?></option>
                ...
                <div class="form-group">
                    ...
                    <img src="../../assets/gambar/<?php
                        ...
                        class="img-thumbnail" width="200" heigth="200" ></center>
        <br>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title">Konfirmasi Perubahan Data Masker <?php echo $data['nama_masker'] ?></h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>

                            <div class="modal-body">
                                apakah anda yakin dengan Data Masker <?php echo $data['nama_masker'] ?> yang telah inputkan?
                            </div>
